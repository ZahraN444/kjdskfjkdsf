...
import { NacTagMatchEnum, nacTagMatchEnumSchema } from './nacTagMatchEnum';
import { NacTagTypeEnum, nacTagTypeEnumSchema } from './nacTagTypeEnum';
import {
  NacTagUsernameAttrEnum,
  nacTagUsernameAttrEnumSchema,
} from './nacTagUsernameAttrEnum';
...
export interface NacTag {
  ...
  type: NacTagTypeEnum;
  usernameAttr?: NacTagUsernameAttrEnum;
  /** if `type`==`match` */
  values?: string[];
  /** if `type`==`vlan` */
  vlan?: string;
...
export const nacTagSchema: Schema<NacTag> = object({
  ...
  match: ['match', optional(nacTagMatchEnumSchema)],
  ...
  type: ['type', nacTagTypeEnumSchema],
  usernameAttr: ['username_attr', optional(nacTagUsernameAttrEnumSchema)],
